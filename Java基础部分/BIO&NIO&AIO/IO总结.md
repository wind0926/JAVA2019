...
[IO的基础BIO字节流字符流梳理以及代码示例](https://blog.csdn.net/u012250875/article/details/78341874)
...
#### 4.1 blocking和non-blocking的区别

调用blocking IO会一直block住对应的进程直到操作完成，而non-blocking IO在kernel还准备数据的情况下会立刻返回。

#### 4.2 synchronous IO和asynchronous IO的区别
